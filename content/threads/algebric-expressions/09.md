...
mathEnable: true
---
اصلا نترس. هر موقع که توی معادله کسر دیدی، کل معادله رو به مخرج اون کسر ضرب کن تا کسر از بین بره. 
{{< readmore type="info" title="مثال" open="true" >}}
این معادله رو برای پیدا کردن x حل کن:
$$\frac{3x}{2}-5x=6$$
حل:
